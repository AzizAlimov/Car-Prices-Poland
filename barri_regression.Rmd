...
transformed_model = crossValidationCont3(train,3,0.5,6)
```
...
```
```{r}
plot(transformed_model$models[[1]]$fitted.values,transformed_model$models[[1]]$residuals)
plot(transformed_model$models[[2]]$fitted.values,transformed_model$models[[2]]$residuals)
plot(transformed_model$models[[3]]$fitted.values,transformed_model$models[[3]]$residuals)
```
...
plot(exp(transformed_model$models[[1]]$fitted.values),res1)
plot(exp(transformed_model$models[[2]]$fitted.values),res2)
plot(exp(transformed_model$models[[3]]$fitted.values),res3)
```